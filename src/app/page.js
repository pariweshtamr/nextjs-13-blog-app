  ...
  return (
    <div className="min-h-[calc(100vh - 60px)] w-full">
      {isLoading ? (
        ...
        <>
          <div className="flex flex-col gap-2 bg-[#FCF6ED] bg-[url('https://www.transparenttextures.com/patterns/xv.png')] bg relative">
            <div className="absolute z-[0] -left-[22rem] top-[6rem] w-[65%] h-[65%] bg-white border-2 border-solid border-[#000] rounded-full rotate-[22deg]"></div>
            <p className="text-center mt-[1.5rem]">Blogs</p>
            ...
            <div className="flex gap-2.5 w-[70%] m-[0_auto] my-[4rem] mb-[5rem] h-[60vh] z-10">
                ...
                {posts?.length &&
                  posts?.slice(1, 4).map((post) => (
                    <div className="flex flex-col p-3" key={post._id}>
                      <div className="flex gap-6 h-[9.5rem]">
